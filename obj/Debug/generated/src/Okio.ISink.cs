...
namespace Okio {
	...
	public partial interface ISink : global::Java.IO.ICloseable, global::Java.IO.IFlushable {
		...
		[Register ("close", "()V", "GetCloseHandler:Okio.ISinkInvoker, OkHttpOkioBinding")]
		void Close ();
		...
		[Register ("flush", "()V", "GetFlushHandler:Okio.ISinkInvoker, OkHttpOkioBinding")]
		void Flush ();
		...
		[Register ("timeout", "()Lokio/Timeout;", "GetTimeoutHandler:Okio.ISinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("write", "(Lokio/Buffer;J)V", "GetWrite_Lokio_Buffer_JHandler:Okio.ISinkInvoker, OkHttpOkioBinding")]
		void Write (global::Okio.Buffer p0, long p1);

	}

	[global::Android.Runtime.Register ("okio/Sink", DoNotGenerateAcw=true)]
	internal class ISinkInvoker : global::Java.Lang.Object, ISink {

		static IntPtr java_class_ref = JNIEnv.FindClass ("okio/Sink");
		IntPtr class_ref;
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ISinkInvoker); }
		}
