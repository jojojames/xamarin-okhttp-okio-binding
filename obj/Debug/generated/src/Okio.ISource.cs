...
namespace Okio {
	...
	public partial interface ISource : global::Java.IO.ICloseable {
		...
		[Register ("close", "()V", "GetCloseHandler:Okio.ISourceInvoker, OkHttpOkioBinding")]
		void Close ();
		...
		[Register ("read", "(Lokio/Buffer;J)J", "GetRead_Lokio_Buffer_JHandler:Okio.ISourceInvoker, OkHttpOkioBinding")]
		...
		[Register ("timeout", "()Lokio/Timeout;", "GetTimeoutHandler:Okio.ISourceInvoker, OkHttpOkioBinding")]
		global::Okio.Timeout Timeout ();

	}

	[global::Android.Runtime.Register ("okio/Source", DoNotGenerateAcw=true)]
	internal class ISourceInvoker : global::Java.Lang.Object, ISource {

		static IntPtr java_class_ref = JNIEnv.FindClass ("okio/Source");
		IntPtr class_ref;
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ISourceInvoker); }
		}
