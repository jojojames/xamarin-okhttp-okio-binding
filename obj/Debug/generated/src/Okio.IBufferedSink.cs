...
namespace Okio {
	...
	public partial interface IBufferedSink : global::Okio.ISink {
		...
		[Register ("buffer", "()Lokio/Buffer;", "GetBufferHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("emit", "()Lokio/BufferedSink;", "GetEmitHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("emitCompleteSegments", "()Lokio/BufferedSink;", "GetEmitCompleteSegmentsHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("outputStream", "()Ljava/io/OutputStream;", "GetOutputStreamHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("write", "([B)Lokio/BufferedSink;", "GetWrite_arrayBHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("write", "([BII)Lokio/BufferedSink;", "GetWrite_arrayBIIHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("write", "(Lokio/ByteString;)Lokio/BufferedSink;", "GetWrite_Lokio_ByteString_Handler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("write", "(Lokio/Source;J)Lokio/BufferedSink;", "GetWrite_Lokio_Source_JHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeAll", "(Lokio/Source;)J", "GetWriteAll_Lokio_Source_Handler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeByte", "(I)Lokio/BufferedSink;", "GetWriteByte_IHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeDecimalLong", "(J)Lokio/BufferedSink;", "GetWriteDecimalLong_JHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeHexadecimalUnsignedLong", "(J)Lokio/BufferedSink;", "GetWriteHexadecimalUnsignedLong_JHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeInt", "(I)Lokio/BufferedSink;", "GetWriteInt_IHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeIntLe", "(I)Lokio/BufferedSink;", "GetWriteIntLe_IHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeLong", "(J)Lokio/BufferedSink;", "GetWriteLong_JHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeLongLe", "(J)Lokio/BufferedSink;", "GetWriteLongLe_JHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeShort", "(I)Lokio/BufferedSink;", "GetWriteShort_IHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeShortLe", "(I)Lokio/BufferedSink;", "GetWriteShortLe_IHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeString", "(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/BufferedSink;", "GetWriteString_Ljava_lang_String_IILjava_nio_charset_Charset_Handler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeString", "(Ljava/lang/String;Ljava/nio/charset/Charset;)Lokio/BufferedSink;", "GetWriteString_Ljava_lang_String_Ljava_nio_charset_Charset_Handler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeUtf8", "(Ljava/lang/String;)Lokio/BufferedSink;", "GetWriteUtf8_Ljava_lang_String_Handler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeUtf8", "(Ljava/lang/String;II)Lokio/BufferedSink;", "GetWriteUtf8_Ljava_lang_String_IIHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
		...
		[Register ("writeUtf8CodePoint", "(I)Lokio/BufferedSink;", "GetWriteUtf8CodePoint_IHandler:Okio.IBufferedSinkInvoker, OkHttpOkioBinding")]
	...
	internal class IBufferedSinkInvoker : global::Java.Lang.Object, IBufferedSink {

		static IntPtr java_class_ref = JNIEnv.FindClass ("okio/BufferedSink");
		IntPtr class_ref;
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (IBufferedSinkInvoker); }
		}
